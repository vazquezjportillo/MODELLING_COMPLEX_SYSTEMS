...
biax.set(xlabel="r", ylabel="x", title="Bifurcation diagram of the Logistic map and Perturbed Logistic map")
legend_elements = [Line2D([0], [0], marker='o', color='r', markerfacecolor='r', markersize=10, label='Logistic Map (f = rx(1-x)'),
                   Line2D([0], [0], marker='o', color='b', markerfacecolor='b', markersize=10, label='Perturbed Logistic Map (f = rx(1-x) + 0.1x⁵)'),
                   Line2D([0], [0], marker='o', color='g', markerfacecolor='g', markersize=10, label='Perturbed Logistic Map (f = rx(1-x)+0.2x⁵)')]
...
biax.set(xlabel="r", ylabel="x", title="Sine map f=rsin(pi*x)")
plt.show()